...
class HpsmIncidentCreateV1
  ...
  def execute()
    ...
    soap_dict = {:"ins0:model" => 
      {:"ins0:keys" => 
        {:"ins0:IncidentID" => @parameters['incient_id']}
      }, 
     :"ins0:instance" => 
      {:"ins0:Service" => @parameters['service'], 
       :"ins0:IncidentID" => @parameters['incident_id'],
       :"ins0:Category" => @parameters['category'],
       :"ins0:Urgency" => @parameters['urgency'],
       :"ins0:AssignmentGroup" => @parameters['assignment_group'],
       :"ins0:Description" => {:"ins0:Description" => @parameters['description']}, :attributes! => {:"ins0:Description" => {:type => "Array"}},
       :"ins0:Area" => @parameters['area'],
       :"ins0:Subarea" => @parameters['subarea'],
       :"ins0:Title" => @parameters['title'],
       :"ins0:Impact" => @parameters['impact']
      },
    ...
    begin
      ...
      response = client.request(:create_incident) do
    ...
    if response.body[:create_incident_response][:@status] != "SUCCESS"
    ...
    <<-RESULTS
    <results>
      <result name="incident_id">#{response.body[:create_incident_response][:model][:keys][:incident_id]}</result>
